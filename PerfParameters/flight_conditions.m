...
function [conditions] = flight_conditions()
    ...
    Condition8 = struct('altitude', 15000, ...
                        'Mach', 1.00,...
                        'Afterburner', 1); 
     %Maximum Payload research mission
    Condition9 = struct('altitude', 70000, ...
                        'Mach', 3.00,...
                        'Afterburner', 1);
                    
    % Cruising Ariplane capacity
    Condition10 = struct('altitude', 85000, ...
                        'Mach', 3.2,...
                        'Afterburner', 1);
                    
    % Acceleration and climb
    Condition11 = struct('altitude', 70000, ...
                        'Mach', 3.0,...
                        'Afterburner', 1);  
